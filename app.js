...
mongoose.connect("mongodb+srv://gauravgupta:GauravGupta@cluster0.eg6n8du.mongodb.net/?retryWrites=true&w=majority", {
...
app.listen(port, () => {
  console.log(`Result app active at http://localhost:${port}`);
});
